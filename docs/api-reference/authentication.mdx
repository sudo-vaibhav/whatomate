...
Whatomate uses JWT (JSON Web Tokens) for authentication. After logging in, you receive an access token and refresh token. Include the access token in the `Authorization` header for all protected API requests.
